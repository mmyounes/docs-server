...
| Data
| 3 (starting 7.6, the data service can automatically failover using a min of 2 data nodes given that there is another node in the cluster that can act as an arbiter)
